                            ...
                            <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            ...
                                            <th class="text-center">Nom & Prenom</th>
                                                ...
                                                <th class="text-center">Affiliation Mutuelle</th>
...
<td class="text-center"><?PHP echo  $patient['Nom_Patient']; echo " "; ?>
...
<td class="text-center"><?PHP echo  $patient['Affiliation_Mutuelle']; ?></td>
