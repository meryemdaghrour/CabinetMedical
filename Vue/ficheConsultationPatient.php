...
include '../Controller/FonctionC.php';
   ...
   if($_SESSION["acces"]!='y')
   {
    ...
    $patient=$fonctionC->getPatientById($_GET['id']);

    if (isset($_GET['id']))
	{
    $fiche=$fonctionC->afficherFichePatient($_GET['id']);
    }
   }
                    ...
                    <div class="main_body">
                        ...
                        <div class="Left-body">
                            <div class="Left-body-head">
                               Fiche Consultation <?php
                                        echo $patient->getNom_Patient().' '.$patient->getPrenom_Patient();
                                   ?>
                            </div>
                            <div class="infos">
                            ...
                            <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Compte Rendu Consultation</th>
...
<td class="text-center"><?PHP echo  $fiche->Date_Consultation ?></td>
<td class="text-center"><?PHP echo  $fiche->Compte_Rendu_Consultation?></td>
<td class="text-center">
<?php 
 echo  $fiche->Medecin->Nom_Medecin; echo " ";
 echo  $fiche->Medecin->Prenom_Medecin; 
 ?>
 </td>
                    ...
                    <div class="Right-body">
                        <div class="About-us">
                            ...
                            <a href="displayPatientCabinet.php"><i class="icon-user"></i> Liste des patients</a>
                                ...
                                <br/>
                                <br/> <a href="displayRDV.php"><i class="icon-calendar"></i> Liste des rendez-vous</a>
                                <hr/>
