                    ...
                    <div class="main_body">
                        ...
                        <div class="Left-body">
                            ...
                            <input class="form-control" type="text" id="search-user" value=""
                             placeholder="Rechercher un ou plusieurs rdv"/>
  ...
  $(document).ready(function(){
    $('#search-user').keyup(function(){
      ...
      if(rdv != ""){
        $.ajax({
          type: 'GET',
          url: 'rechercherRDV.php',
          data: 'user=' + encodeURIComponent(rdv),
          success: function(data){
            if(data != ""){
              $('#result-search').append(data);
            }else{
              document.getElementById('result-search').innerHTML = "<div style='font-size: 20px; text-align: center; margin-top: 10px'>Aucun rdv</div>"
            }
          }
        });
      }
